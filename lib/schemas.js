...
var Schemas = function(ajv, schemaPathsMap) {
  this._ajv = ajv;
};
...
Schemas.readExternalExamples = function(schemaPathsMapItem){
...
Schemas.readExternalDescription = function(schemaPathsMapItem) {
 ...
 */
Schemas.process = function(schemaPathsMap, schemaPath, docDir, schemaDir, metaElements, readme, docs) {
  smap = schemaPathsMap;
  ...
  return Promise.mapSeries(keys, schemaKey => {
    ...
    return Schema.readExternalExamples(schemaPathsMap[schemaKey])
      .then(egsSchema => Schema.readExternalDescription(schemaPathsMap[schemaKey]))
      .then(allSchema => {
